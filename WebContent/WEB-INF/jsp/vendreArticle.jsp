...
<body>
	...
	<div class="container" style="max-width: 600px;">
		...
		<h6>Mise à prix :</h6>
		<div class="form-outline mb-4">
			<input type="number" min="0" id="form7Example1" class="form-control" />
		</div>
		...
		<section class="border p-4 mb-4">
			<div class="form-outline">
				...
				<label class="form-label" for="formControlDefault">Rue :</label>
			</div>
			<br>
			<div class="form-outline">
				<input type="number" id="formControlDefault" class="form-control" />
				<label class="form-label" for="formControlDefault">Code
					postal :</label>
			</div>
			<br>
			<div class="form-outline">
				<input type="text" value="Le nom de ma vile" id="formControlDefault" class="form-control" />
				<label class="form-label" for="formControlDefault">Ville :</label>
			</div>
		</section>
		<br>
		<div class="d-grid gap-2 d-md-block">
			<button class="btn-block btn-primary" type="button">Enregistrer</button>
